...
def run_migrations_online() -> None:
    ...
    Here we sync engine connecting to psycopg to bypass Asyncpg auth string parsing bugs locally.
    """
    
    # Strip +asyncpg to fall back to the standard psycopg sync engine internally
